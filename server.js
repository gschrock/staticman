...
class StaticmanAPI {
  ...
  requireApiVersion(versions) {
    console.log("server requireApiVersion: ", versions);
    return (req, res, next) => {
  ...
  requireService(services) {
    console.log("server requireService: ", services);
    return (req, res, next) => {
      const serviceMatch = services.some(
        service => service === req.params.service
      );
  ...
  requireParams(params) {
    console.log("server requireParams: ", params);
  ...
  start(callback) {
    ...
    console.log("server state: this.instance");
  }
